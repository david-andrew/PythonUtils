...
import pdb
# TODO: might be good to split this into functions that could take a list of files in some datastructure vs one that uses the current root path to generate that structure?
